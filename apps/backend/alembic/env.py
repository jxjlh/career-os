"""Alembic environment — async SQLAlchemy 2 + asyncpg.

Migrations are stored separately in apps/backend/alembic/versions/.
"""
...
# Override sqlalchemy.url with the async driver
