    ...
    try {
      ...
      let finished = false;
          for (let index = 0; index < 30; index += 1) {
            ...
            let job: Envelope;
            try {
              job = await apiFetch<Envelope>(`/explore/jobs/${response.data.jobId}`);
            } catch {
              // Ignore one transient proxy/VPS connection failure and keep polling.
              continue;
            }
