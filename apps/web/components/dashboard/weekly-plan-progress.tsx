  ...
  if (!progress || (!progress.planId && progress.goalsActive === 0 && progress.wordsLearnedThisWeek === 0)) {
    return (
      ...
      >
        ...
        <div className="mt-3 flex items-center justify-between rounded-[14px] border border-dashed border-border-subtle bg-surface px-5 py-4">
          <div>
  ...
  return (
    ...
    >
      ...
      <div className="mt-5 grid grid-cols-3 gap-3">
        <a
          href="/planner"
          className="group rounded-[12px] border border-border-subtle bg-surface p-3 transition-colors hover:bg-surface-elevated"
        >
        ...
        <div className="mt-4 space-y-1.5">
          {progress.goals.slice(0, 3).map((goal) => (
            <Link
              ...
              className="group flex items-center gap-3 rounded-[10px] px-2 py-1.5 transition-colors hover:bg-surface-elevated"
            >
              <span className="min-w-0 flex-1 truncate text-[12px] text-text-secondary group-hover:text-text">
                {goal.title}
              </span>
              <div className="h-[3px] w-16 overflow-hidden rounded-full bg-surface-muted">
                <div
