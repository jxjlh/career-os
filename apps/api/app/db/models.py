...
class FinanceRecommendation(Base):
    ...
    suggested_amount_min: Mapped[Decimal | None] = mapped_column(Numeric(16, 4))
    suggested_amount_max: Mapped[Decimal | None] = mapped_column(Numeric(16, 4))
    position_change_pct: Mapped[Decimal | None] = mapped_column(Numeric(8, 6))
